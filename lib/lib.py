...
def generate_fnames(obj,model_pars='',coupling_pars=''):
    ...
    v = '{}z_data_{}{}{}.txt'
    obj.z['dat_fnames'] = [v.format(obj.dir,k,
                                    model_pars,
                                    sim_pars)
                           for k in range(obj.miter)]
    
    v = '{}i_data_{}{}{}.txt'
    obj.i['dat_fnames'] = [v.format(obj.dir,k,
                                    model_pars,
                                    sim_pars)
                           for k in range(obj.miter)]
    ...
    for i in range(obj.N):
        ...
        v = '{}g{}_data_{}{}{}.txt'
        obj.g[i]['dat_fnames'] = [v.format(obj.dir,i,k,
                                           model_pars,
                                           sim_pars)
                                  for k in range(obj.miter)]

        v = '{}z{}_data_{}{}{}.txt'
        obj.z[i]['dat_fnames'] = [v.format(obj.dir,i,k,
                                           model_pars,
                                           sim_pars)
                                  for k in range(obj.miter)]

        v = '{}i{}_data_{}{}{}.txt'
        obj.i[i]['dat_fnames'] = [v.format(obj.dir,i,k,
                                           model_pars,
                                           sim_pars)
                                  for k in range(obj.miter)]
    ...
    for key in obj.var_names:
        v = '{}g{}_sym_{}.d'
        obj.g['sym_fnames_'+key] = [v.format(obj.dir,key,k)
                                    for k in range(obj.miter)]
        
        v = '{}z{}_sym_{}.d'
        obj.z['sym_fnames_'+key] = [v.format(obj.dir,key,k)
                                    for k in range(obj.miter)]
        
        v = '{}i{}_sym_{}.d'
        obj.i['sym_fnames_'+key] = [v.format(obj.dir,key,k)
                                    for k in range(obj.miter)]
        
        v = '{}g_eps_{}_miter={}.d'.format(obj.dir,key,obj.miter)
        obj.g[key+'_eps_fname'] = v
        
        v = '{}z_eps_{}_miter={}.d'.format(obj.dir,key,obj.miter)
        obj.z[key+'_eps_fname'] = v
        
        v = '{}i_eps_{}_miter={}.d'.format(obj.dir,key,obj.miter)
        obj.i[key+'_eps_fname'] = v
        
        for i in range(obj.N):
            v = '{}g{}_eps_{}_miter={}.d'.format(obj.dir,i,key,obj.miter)
            obj.g[i][key+'_eps_fname'] = v
            
            v = '{}i{}_eps_{}_miter={}.d'.format(obj.dir,i,key,obj.miter)
            obj.i[i][key+'_eps_fname'] = v

            v = '{}z{}_eps_{}_miter={}.d'.format(obj.dir,i,key,obj.miter)
            obj.z[i][key+'_eps_fname'] = v

    
    for key in obj.var_names:
        for i in range(obj.N):
            v = '{}g{}_sym_{}.d'
            obj.g[i]['sym_fnames_'+key] = [v.format(obj.dir,key,k)
                                           for k in range(obj.miter)]

            v = '{}z{}_sym_{}.d'
            obj.z[i]['sym_fnames_'+key] = [v.format(obj.dir,key,k)
                                           for k in range(obj.miter)]

            v = '{}i{}_sym_{}.d'
            obj.i[i]['sym_fnames_'+key] = [v.format(obj.dir,key,k)
                                           for k in range(obj.miter)]
